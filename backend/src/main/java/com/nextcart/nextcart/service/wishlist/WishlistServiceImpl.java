...
public class WishlistServiceImpl implements WishlistService {
    ...
    private WishlistResponseDTO mapToDTO(Wishlist wishlist) {
        ...
        Double priceValue = (product.getPrice() != null) ? product.getPrice().doubleValue() : null;
