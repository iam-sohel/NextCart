...
import com.nextcart.nextcart.product_module.productInformation.exceptions.ProductInformationAlreadyExistsException;
import com.nextcart.nextcart.product_module.productInformation.exceptions.ProductInformationNotFoundException;
...
import com.nextcart.nextcart.product_module.productInformation.entity.ProductInformationEntity;
import com.nextcart.nextcart.product_module.productInformation.mapper.ProductInformationMapper;
import com.nextcart.nextcart.product_module.productInformation.repository.ProductInformationRepository;
...
public class ProductInformationServiceImpl
    ...
    public ProductInformationResponse createInformation(
        ...
        if (productInformationRepository
                .existsByProductEntity_Id(productId)) {
    ...
    public void deleteInformation(Long id) {
        ...
        productInformationRepository.delete(
                information
        );
    }
}