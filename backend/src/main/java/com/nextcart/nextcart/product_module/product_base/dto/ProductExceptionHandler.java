...
import com.nextcart.nextcart.product_module.product_base.exceptions.*;
...
public class ProductExceptionHandler {
    ...
    public ResponseEntity<CommonResponseDto<Void>> handleSlugAlreadyExists(
    ...
    public ResponseEntity<CommonResponseDto<Void>> handleAlreadyActive(
    ...
    public ResponseEntity<CommonResponseDto<Void>> handleAlreadyInactive(
    ...
    public ResponseEntity<CommonResponseDto<Void>> handleProductValidation(
