package com.nextcart.nextcart.product_module.productVariant.controller;

import com.nextcart.nextcart.common.dto.CommonResponseDto;
import com.nextcart.nextcart.product_module.productVariant.service.ProductVariantService;
...
public class ProductVariantController {
    ...
    public ResponseEntity<
            CommonResponseDto<ProductVariantResponse>
            > createVariant(
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'SELLER')")
    public ResponseEntity<
            CommonResponseDto<Page<ProductVariantResponse>>
