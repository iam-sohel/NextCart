...
public class AdminSubCategoryController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Page<SubCategoryResponse>>> getAllSubCategories(
            @PageableDefault(
                    size = 20,
                    sort = "name",
    ...
    public ResponseEntity<ApiResponse<Page<SubCategoryResponse>>> getSubCategoriesByCategory(
