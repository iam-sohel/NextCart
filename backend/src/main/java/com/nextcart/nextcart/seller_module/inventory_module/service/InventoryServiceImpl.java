...
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryItemNotFoundException;
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryNotFoundException;
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryProductVariantAlreadyExistsException;
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryProductVariantNotFoundException;
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryStockException;
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryValidationException;
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryWarehouseException;
import com.nextcart.nextcart.seller_module.inventory_module.exceptions.InventoryWarehouseInactiveException;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    public InventoryResponse createInventory(
        ...
        Warehouse warehouse = warehouseRepository
                ...
                .orElseThrow(() ->
                        new InventoryWarehouseException(
        ...
        if (!"ACTIVE".equalsIgnoreCase(
            ...
            throw new InventoryWarehouseInactiveException(
        ...
        ProductVariantEntity productVariant =
                productVariantRepository
                        ...
                        .orElseThrow(() ->
                                new InventoryProductVariantNotFoundException(
        ...
        if (inventoryItemRepository
            ...
            throw new InventoryProductVariantAlreadyExistsException(
    ...
    public InventoryResponse getInventoryByWarehouse(
            Long userId,
            Long warehouseId
    ) {
    ...
    public InventoryResponse updateInventoryItem(
        ...
        Warehouse warehouse =
                item.getInventory().getWarehouse();
        ...
        int reserved =
                safeStock(item.getReservedStock());
    ...
    public Integer getTotalAvailableStock(
        ...
        return inventoryItemRepository
                ...
                .stream()
                .mapToInt(item ->
                        safeStock(item.getAvailableStock())
                )
                .sum();
    }
    ...
    // =========================================================
    // BACKWARD-COMPATIBLE ORDER SERVICE METHODS
    // =========================================================
    ...
    public void reserveStock(
        ...
        InventoryItem item =
                findLockedItemWithAvailableStock(
                        productVariantId,
                        quantity
                );
    ...
    public void releaseStock(
        ...
        InventoryItem item =
                findLockedItemWithReservedStock(
                        productVariantId,
                        quantity
                );
    ...
    public void restoreStock(
        ...
        InventoryItem item =
                findLockedItem(productVariantId);
    ...
    private InventoryItem getLockedItem(
            Long warehouseId,
            Long productVariantId
    ) {
    ...
    private InventoryItem findLockedItem(
            Long productVariantId
    ) {
        ...
        return inventoryItemRepository
                .findByInventoryIdAndProductVariantIdForUpdate(
                        first.getInventory().getId(),
                        productVariantId
                )
                .orElseThrow(() ->
                        new InventoryItemNotFoundException(
                                "Inventory item not found for product variant: "
                                        + productVariantId
                        )
                );
    }
    ...
    // =========================================================
    // FIND LOCKED ITEM WITH AVAILABLE STOCK
    // =========================================================
    ...
    // =========================================================
    // FIND LOCKED ITEM WITH RESERVED STOCK
    // =========================================================
    ...
    private InventoryItem findLockedItemWithReservedStock(
        ...
        throw new InventoryStockException(
                "Reserved inventory not found for product variant: "
                        + productVariantId
        );
    }
    ...
    private void verifyWarehouseOwnership(
            Warehouse warehouse,
            Seller seller
    ) {

        if (warehouse == null
                || warehouse.getSeller() == null
                || !warehouse.getSeller()
                        .getId()
                        .equals(seller.getId())) {

            throw new InventoryWarehouseException(
                    "Warehouse does not belong to seller"
            );
        }
    }
    ...
    private InventoryItemResponse mapItem(
            InventoryItem item
    ) {
    ...
    private int safeAdd(
        ...
        long result =
                (long) current + quantity;

        if (result > Integer.MAX_VALUE) {
            throw new InventoryStockException(
                    "Stock quantity exceeds maximum allowed value"
            );
        }
    ...
    @Override
    @Transactional(readOnly = true)
    public List<InventoryItemResponse>
    getInventoryItemsByProductVariantId(
            Long productVariantId
    ) {
