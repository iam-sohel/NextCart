...
// Use the first product as the showcase product for this static hero.
...
export default function Hero() {
  return (
    <Box
      ...
      sx={{
        width: "100%",
        bgcolor: "#2A1F18", // dark warm-brown background
        color: "#F4EFE6",
        mt: 2,
        borderRadius: 0,
        overflow: "hidden",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <LocalOfferIcon sx={{ fontSize: 18, color: "#F15A29" }} />
            <Typography
              variant="overline"
              sx={{
                fontWeight: 700,
        ...
        <Box
          sx={{
            ...
            borderRadius: 2,
            bgcolor: "#F4EFE6", // cream product stage
            display: "flex",
            alignItems: "center",
